  ...
  <body class="d-flex flex-column">
    ...
    <main class="container my-3 bg-white rounded-5 d-flex flex-column gap-4 login">
        ...
        <div>
            ...
            <input type="email" id="email" class="form-control" aria-describedby="Preencha o campo de e-mail" placeholder="usuario@dominio.com.br">
        </div>

        <div>
            <label for="password" class="form-label"><strong>Senha</strong></label>
            <input type="password" id="password" class="form-control" aria-describedby="Preencha o campo senha" placeholder="Digite sua senha">
        <div>

        <div class="d-grid mt-5">
            <button class="btn btn-primary rounded-5 btn" type="button">Continuar</button>
        </div>        
    </main>    
