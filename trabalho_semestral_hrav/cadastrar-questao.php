  ...
  <body class="d-flex flex-column">
    ...
    <main class="container my-3 bg-white rounded-5 d-flex flex-column gap-5 p-5">
        ...
        <div>
            ...
            <textarea class="form-control" id="questao" rows="4" placeholder="Digite a descrição da questão"></textarea>
        </div>

        <div>
            <label for="questao" class="form-label">Setor:<span style="color: red;">*</span></label>
            <select class="form-select" aria-label="Default select example">
                <option selected>Selecione um setor</option>
                <option value="1">Maternidade</option>
                <option value="2">Internação</option>
                <option value="3">UTI - Unidade de Terapia Intensiva</option>
            </select>
        </div>
